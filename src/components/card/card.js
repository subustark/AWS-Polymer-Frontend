    ...
    return(
        ...
        <div className="body1 d-flex flex-column"  >
            <div className="d-flex" >
                ...
                <div><h6 style={{padding:"3px",fontSize:"0.8rem" ,backgroundColor:"#E8FE8C",borderRadius:"5px"}} > {data.full_name} </h6></div>
            </div>
            <div className="d-flex" >
                <div><h6 style={{fontSize:"0.8rem",width:"6rem"}} ><b>Owner </b></h6></div>
                <div><h6 style={{padding:"3px",fontSize:"0.8rem",backgroundColor:"#8CCAFE" ,borderRadius:"5px"}} > {data.owner.login} </h6></div>
            </div>
        </div>
        <hr/>
        ...
        <div className="d-flex flex-column " >
                ...
                <div><h6 style={{padding:"3px",fontSize:"0.8rem" ,backgroundColor:"#FECA8C",borderRadius:"5px"}} > {data.stargazers_count} </h6></div>
            </div>
            <div className="d-flex flex-column" >
                <div><h6 style={{fontSize:"0.8rem"}} >Language</h6></div>
                <div><h6 style={{padding:"3px",fontSize:"0.8rem",backgroundColor:"#B98CFE" ,borderRadius:"5px"}} > {data.language} </h6></div>
            </div>
            <div className="d-flex flex-column" >
                <div><h6 style={{fontSize:"0.8rem"}} >forks</h6></div>
                <div><h6 style={{padding:"3px",fontSize:"0.8rem",backgroundColor:"#FC616D " ,borderRadius:"5px"}} > {data.forks_count} </h6></div>
            </div>
        </div>
     </Div>
        <Modal 
