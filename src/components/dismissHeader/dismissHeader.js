...
export default function DismissHeader()
{
    ...
    return(
        ...
        <div className="dismissText"><h6 style={{fontWeight:"bold"}}>⚡Transform your spreadsheet into a powerful search and insights engine with polymer search. <a href="https://www.polymersearch.com/?utm_source=aws" target="_blank" rel="noreferrer">Learn more.</a></h6></div>
